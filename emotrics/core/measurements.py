...
def estimate_line(circle_left, circle_right):
    ...
    # Calcular la pendiente, manejando el caso de línea vertical
    if abs(x_2 - x_1) < 1e-10:  # Si los puntos están prácticamente alineados verticalmente
        m = float('inf')  # Pendiente infinita para línea vertical
    else:
        m = (y_2 - y_1) / (x_2 - x_1)
